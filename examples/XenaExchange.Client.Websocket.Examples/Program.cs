...
namespace XenaExchange.Client.Websocket.Examples
{
    class Program
    {
        ...
        private static async Task NoDIExampleAsync()
        {
            ...
            var tradingExample = new TradingExample(tradingWsClient, _tradingWsOptions, Logging.ConsoleLogger<TradingExample>(logLevel));
        ...
        private static async Task DIExampleAsync()
        {
            var services = new ServiceCollection()
                            ...
                            .AddSingleton<MarketDataExample>()
                            .BuildServiceProvider();

            var tradingExample = services.GetService<TradingExample>();
            var mdExample = services.GetService<MarketDataExample>();
